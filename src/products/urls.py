...
from .views import CreateCategoryAPI, CreateProductAPI, DeleteCategoryAPI, DeleteProductAPI, GetAllCategoriesAPI, GetAllProductsAPI, GetCategoryByIdAPI, GetProductByIdAPI, UpdateCategoryAPI, UpdateProductAPI
