...
from .serializers import SaleCreateSerializer, SaleSerializer, SaleDetailSerializer
from .selectors import get_all_sales, get_sale_detail_by_id, get_sales_details_by_id_customer
